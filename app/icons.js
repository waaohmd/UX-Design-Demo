export function Icon({ name, size = 24, stroke = 2 }) {
  const paths = {
    ...
    building: <><path d="M3 21h18M6 21V5l6-3v19M18 21V9l-6-2"/><path d="M9 9h.01M9 13h.01M9 17h.01M15 13h.01M15 17h.01"/></>,
    payroll: <><rect x="3" y="6" width="18" height="14" rx="2"/><path d="M3 10h18M7 15h2"/></>,
